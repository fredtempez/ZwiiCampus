...
<?php echo template::table([1, 2, 2, 2, 1, 2, 1, 1], user::$users, ['Id', 'Nom', 'Rôle / Profil', 'Groupes', 'Étiquettes', 'Dernière connexion', '', ''], ['id' => 'dataTables'], ['id', 'name', 'role', 'profile', 'tag', 'data-timestamp', 'edit', 'delete']); ?>