...
<?php echo template::table([2, 2, 1, 2, 1, 2, 1, 1], user::$users, ['Nom', 'Courriel', 'Rôle / Profil', 'Groupes', 'Étiquettes', 'Dernière connexion', '', ''], ['id' => 'dataTables'], ['name', 'mail', 'role', 'profile', 'tag', 'data-timestamp', 'edit', 'delete']); ?>